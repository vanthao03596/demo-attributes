(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["/js/fullcalendar"],{
...
/***/ "./resources/js/vendor/fullcalendar-cortal.js":
/*!****************************************************!*\
  !*** ./resources/js/vendor/fullcalendar-cortal.js ***!
  \****************************************************/
/*! no static exports found */
...
/* WEBPACK VAR INJECTION */(function(jQuery) {(function ($) {
  $.fn.fullCalendarCortal = function (options) {
    ...
    var settings = $.extend({
      ...
      template: '<div class="panel cortal">' + '<div class="panel-body">' + '<div class="calendar"></div>' + '</div>' + '</div>'
    }, options);
    return this.each(function () {
      var $cortal = $(this);
      $cortal.html(settings.template); // Initialize FullCalendar

      var $calendar = $(this).find('.calendar').fullCalendar($.extend(settings, {
        // Handle view change and date range change
        viewDestroy: function viewDestroy(view, element) {
        ...
        select: function select(start, end) {
          if (settings.cortalPopupBreakPoint && $(window).width() <= settings.cortalPopupBreakPoint) {
            ...
            $('.popover').remove(); // Catch selected cells

            $cell = $('.fc-highlight, .fc-helper').last(); // Attach popovers
          ...
          $('.cortal-event-form')[0].reset(''); // Initialize fields
          ...
          bindFormFields(); // Toggle time selection
          ...
          $('.cortal-event-form').submit(function (domEvent) {
            domEvent.preventDefault(); // Get field values
            ...
            var isAllDay = $(this).find('input[name=isAllDay]').is(':checked'); // Create event object
            ...
            $calendar.fullCalendar('renderEvent', calendarEvent, true); // Save event to the backend
        ...
        // Handle event click
        eventClick: function eventClick(calendarEvent, domEvent, view) {
          if (settings.cortalPopupBreakPoint && $(window).width() <= settings.cortalPopupBreakPoint) {
          ...
          $('.cortal-event-form-edit')[0].reset(''); // Initialize fields
          ...
          $('.cortal-event-form-edit *[data-cortal-action=delete]').click(function (domEvent) {
            ...
            title: 'Confirm',
            html: true,
            content: '<p>Are you sure you want to delete this event?</p>' + '<a href="javascript:" class="btn btn-danger">Yes</a> ' + '<a href="javascript:" class="btn btn-default">No</a>',
            trigger: 'click',
            placement: 'top'
            ...
            $(this).next('.popover').find('.btn-danger').click(function (e) {
              ...
              $popover.popover('hide'); // Hide popover
        ...
        eventResize: function eventResize(calendarEvent, delta, revertFunc) {
          // Save event to the backend
          if ($.isFunction(settings.eventUpdate)) {
            settings.eventUpdate($calendar, calendarEvent);
          }
        },
        eventDrop: function eventDrop(calendarEvent, delta, revertFunc, domEvent, ui, view) {
    ...
    function hideCortalForms($calendar) {
      var hideModal = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
    ...
    function getFormHtml() {
      var isEditForm = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
      var htmlForm = '<form class="cortal-event-form' + (isEditForm === true ? '-edit' : '') + '">' + '<input type="hidden" name="id" />';
    ...
    function showCortalPopupForm(isEditForm) {
      ...
      if ($('#cortalDialog').length > 0) {
        $('#cortalDialog').find('.modal-body').html(getFormHtml(isEditForm)); //make sure default view is selected

        $('#cortalDialog').modal('show');
        return;
      }

      $('body').append('<div aria-hidden="true" aria-labelledby="cortal-dialog" role="dialog" tabindex="-1" id="cortalDialog" class="modal fade">' + '<div class="modal-dialog">' + '<div class="modal-content">' + '<div class="modal-header">' + '<button aria-hidden="true" data-dismiss="modal" class="close" type="button">&times;</button>' + '<h4 id="myModalLabel" class="modal-title">Booking</h4>' + '</div>' + '<div class="modal-body">' + getFormHtml(isEditForm) + '</div>' + '</div><!-- /.modal-content -->' + '</div><!-- /.modal-dialog -->' + '</div>'); //make sure default view is selected
...
/* harmony import */ var _fullcalendar_cortal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./fullcalendar-cortal */ "./resources/js/vendor/fullcalendar-cortal.js");
/* harmony import */ var _fullcalendar_cortal__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_fullcalendar_cortal__WEBPACK_IMPORTED_MODULE_1__);
...
/***/ 3:
/*!***************************************************!*\
  !*** multi ./resources/js/vendor/fullcalendar.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/phamthao/Desktop/code/cortex-1.0.4/resources/js/vendor/fullcalendar.js */"./resources/js/vendor/fullcalendar.js");
