...
class LogsDataTable extends AbstractDataTable
{
    ...
    protected function getBuilderParameters(): array
    {
        return [
            ...
            'buttons' => [
                ...
                ['extend' => 'colvis', 'text' => '<i class="fa fa-columns"></i> '.trans('common.columns').' <span class="caret"/>'],
                ['extend' => 'pageLength', 'text' => '<i class="fa fa-list-ol"></i> '.trans('common.limit').' <span class="caret"/>'],
            ],
        ];
    }
    ...
    protected function getColumns(): array
    {
        return [
            ...
            'causer' => ['title' => trans('common.causer'), 'name' => 'causer.username', 'searchable' => false, 'orderable' => false, 'render' => 'full.causer_route ? "<a href=\""+full.causer_route+"\">"+data+"</a>" : data', 'responsivePriority' => 0],
