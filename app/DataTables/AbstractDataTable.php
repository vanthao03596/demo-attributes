...
abstract class AbstractDataTable extends DataTable
{
    ...
    {
        $createButton = ['extend' => 'create', 'text' => '<i class="fa fa-plus"></i> '.trans('common.new')];
        $columnsButton = ['extend' => 'colvis', 'text' => '<i class="fa fa-columns"></i> '.trans('common.columns').' <span class="caret"/>'];
        $lengthButton = ['extend' => 'pageLength', 'text' => '<i class="fa fa-list-ol"></i> '.trans('common.limit').' <span class="caret"/>'];
